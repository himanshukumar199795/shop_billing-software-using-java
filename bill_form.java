/*
 *this project is just for knowledge  purpose does not contain any copyright. 
 */
package bill_system;
      ...
      int result = NO_SUCH_PAGE;    
        ...
        try{
            ...
            ///////////////// Product price Get ///////////
             ...
             g2d.setFont(new Font("Practice code ",Font.PLAIN,9));
            g2d.drawString("-------------------------------------",12,y);y+=yShift;
            g2d.drawString("             Bill Receipt            ",12,y);y+=yShift;
            g2d.drawString("-------------------------------------",12,y);y+=headerRectHeight;
      
            g2d.drawString("-------------------------------------",10,y);y+=yShift;
            g2d.drawString(" Item purchased          Total Price   ",10,y);y+=yShift;
            ...
            g2d.drawString("  judt call:1122334455               ",10,y);y+=yShift;
            g2d.drawString("*************************************",10,y);y+=yShift;
            g2d.drawString("    THANKS TO VISIT           \ndesigned by ©hk",10,y);y+=yShift;
            g2d.drawString("*************************************",10,y);y+=yShift;
...
//            g2d.drawString("Customer Shopping Invoice", 30,y);y+=yShift; 
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(15, 0, 0));
        ...
        jLabel8.setText("Bill Receipt Printing System");
